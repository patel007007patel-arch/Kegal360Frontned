...
const SessionListTable = ({ sessionData, setAddSessionOpen, setEditSessionOpen, setSelectedSession, onRefresh }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('sessionType', {
        header: 'Type',
        cell: ({ row }) => (
          <Chip label={row.original.sessionType} size='small' variant='outlined' />
        )
      }),
      columnHelper.accessor('sequence', {
        ...
        cell: ({ row }) => (
          <Typography color='text.primary'>
            {row.original.sequence?.displayName || row.original.sequence?.name || 'N/A'}
          </Typography>
        )
      }),
