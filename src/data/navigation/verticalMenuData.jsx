const verticalMenuData = dictionary => [
  // K360 Admin Panel - All pages directly in sidebar
  {
    label: 'Dashboard',
...
// Export only admin menu for K360 app - All pages directly in sidebar
...
// Keep original export for backward compatibility but filter to only admin
const originalVerticalMenuData = dictionary => [
  {
